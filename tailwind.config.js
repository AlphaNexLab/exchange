  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "mesh-gradient":
          "radial-gradient(ellipse 800px 600px at 50% 0%, rgba(59, 130, 246, 0.15), transparent 50%), radial-gradient(ellipse 600px 800px at 100% 100%, rgba(168, 85, 247, 0.1), transparent 50%)",
        noise:
          'url("data:image/svg+xml,%3Csvg viewBox=\'0 0 400 400\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cfilter id=\'noiseFilter\'%3E%3CfeTurbulence type=\'fractalNoise\' baseFrequency=\'0.9\' numOctaves=\'4\' stitchTiles=\'stitch\'/%3E%3C/filter%3E%3Crect width=\'100%\' height=\'100%\' filter=\'url(%23noiseFilter)\' opacity=\'0.02\'/%3E%3C/svg%3E")',
      },
      animation: {
      ...
      keyframes: {
        ...
        glowPulse: {
          ...
          "50%": {
            boxShadow:
              "0 0 40px rgba(212, 160, 82, 0.6), 0 0 60px rgba(212, 160, 82, 0.3)",
          },
        },
        meshShift: {
        ...
        judgeVerify: {
          "0%": {
            transform: "scale(1)",
            boxShadow: "0 0 0 0 rgba(212, 160, 82, 0.7)",
          },
          "70%": {
            transform: "scale(1.1)",
            boxShadow: "0 0 0 10px rgba(212, 160, 82, 0)",
          },
          "100%": {
            transform: "scale(1)",
            boxShadow: "0 0 20px rgba(212, 160, 82, 0.4)",
          },
        },
        networkPulse: {
          "0%, 100%": { opacity: "0.3" },
        ...
        trustGlow: {
          ...
          "100%": {
            boxShadow:
              "0 0 20px rgba(245, 158, 11, 0.6), 0 0 30px rgba(245, 158, 11, 0.3)",
          },
        },
      },
      fontFamily: {
        ...
        brand: ["var(--font-brand)", "Syne", "system-ui", "sans-serif"],
      },
      letterSpacing: {
        tighter: "-0.02em",
        tight: "-0.01em",
